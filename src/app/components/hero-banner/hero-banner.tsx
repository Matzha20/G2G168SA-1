                    ...
                    <div className="row justify-content-between">
                        <div className="col-lg-6">
                            <div className="slider__content">
                                <h6 className="sub-title wow fadeInUp" data-wow-delay=".2s">ยินดีตอนรับ</h6>
                                <h2 className="title wow fadeInUp" data-wow-delay=".5s">G2G168SA</h2>
                                <p className="wow fadeInUp" data-wow-delay=".8s">Sport Betting And Casino</p>
                                <div className="slider__btn wow fadeInUp" data-wow-delay="1.2s">
                                    <Link href="/contact" className="tg-btn-1"><span>เข้าสู่ระบบ</span></Link>
                                </div>
                            </div>
                        </div>
