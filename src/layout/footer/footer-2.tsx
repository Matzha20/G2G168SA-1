                ...
                <div className="row">
                    <div className="col-md-4 col-sm-7 order-1 order-md-0">
                        <div className="footer-el-widget">
                            ...
                            <ul className="list-wrap">
                                ...
                                <li><Link href="https://lin.ee/Ah2WMCh" target='blank'>LINE : @G2G168SA</Link></li>
                    ...
                    <div className="col-md-4 col-sm-7 order-3">
                        <div className="footer-el-widget text-start text-md-end">
                            ...
                            <ul className="list-wrap">
                                <li><Link href="https://g2g168sa.life/login">เข้าสู่งระบบ</Link></li>
                                <li><Link href="https://g2g168sa.life/register">สมัครสมาชิก</Link></li>
